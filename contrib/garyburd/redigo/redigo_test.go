...
func TestClient(t *testing.T) {
	...
	c, err := DialWithServiceName("my-service", testTracer, "tcp", "127.0.0.1:7007")
	assert.Nil(err)
	c.Do("SET", 1, "truck")
	...
	assert.Equal(span.GetMeta("out.port"), "7007")
...
func TestInheritance(t *testing.T) {
	...
	client, err := DialWithServiceName("my_service", testTracer, "tcp", "127.0.0.1:7007")
	assert.Nil(err)
	...
	assert.Equal(child_span.GetMeta("out.port"), "7007")
}
...
func TestPool(t *testing.T) {
	...
	pool := &redis.Pool{
		...
		Dial: func() (redis.Conn, error) {
			return DialWithServiceName("my-service", testTracer, "tcp", "127.0.0.1:7007")
		},
	}
